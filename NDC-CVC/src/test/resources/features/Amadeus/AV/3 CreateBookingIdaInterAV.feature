...
@CT08 
Cenário: Post de criação de reserva com um adulto em voo BOG/MDE 
...
@CT09 
Cenário: Post de criação de reserva com um adulto e uma criança em voo GRU/BOG
...
@CT10 
Cenário: Post de criação de reserva com um adulto e um bebê em voo GIG/BOG
    ...
    @CT11
Cenário: Post de criação de reserva com nove adultos em voo GRU/MDE
    ...
    @CT12
Cenário: Post de criação de reserva com um adulto e oito crianças em voo MDE/GIG
...
Cenário: Post de criação de reserva com três adultos, três crianças e três bebês em voo GRU/MAD
    ...
    @CT14
Cenário: Post de criação de reserva com um adulto estrangeiro em voo BOG/GRU

...
Funcionalidade: Validação de post em emissão de reserva para voo ida da companhia AVIANCA
    Eu como usuário quero emitir minha reserva aérea somente ida da companhia AVIANCA


    Cenário: Post de emissão de reserva com um adulto em voo ida BOG/MDE 
    ...
    Cenário: Post de emissão de reserva com um adulto e uma criança em voo ida GRU/BOG 
    ...
    Cenário: Post de emissão de reserva com um adulto e um bebÊ em voo ida GIG/BOG 
    ...
    Cenário: Post de emissão de reserva com nove adultos em voo ida GRU/MDE 
    ...
    Cenário: Post de emissão de reserva com um adulto e oito crianças em voo ida MDE/GIG
    ...
    Cenário: Post de emissão de reserva com três adultos, três crianças e três bebês em voo ida GRU/MAD
    ...
    Cenário: Post de emissão de emissão com um adulto estrangeiro em voo ida BOG/GRU

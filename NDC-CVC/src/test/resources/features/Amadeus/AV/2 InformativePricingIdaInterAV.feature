...
Funcionalidade: Validação de get em InformativePricing Ida
  ...
  @CT08 
  Cenário: Get de confirmação de preço com um adulto BOG/MDE 
    ...
    Então válido em body response chegada no aeropoto "MDE"
    E guardo rateToken para utilizar em booking "bTokenCT01"
    

  @CT09
   Cenário: Get de confirmação de preço com um adulto e uma criança GRU/BOG
  ...
  @CT10
  Cenário: Get de confirmação de preço com um adulto e um bebê GIG/BOG
  ...
  @CT11
  Cenário: Get de confirmação de preço com nove adultos GRU/MDE
  ...
  @CT12
  Cenário: Get de confirmação de preço com um adulto e oito crianças MDE/GIG

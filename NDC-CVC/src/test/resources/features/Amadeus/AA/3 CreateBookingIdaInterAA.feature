...
@CT08 
Cenário: Post de criação de reserva com um adulto em voo MIA/LGA 
...
@CT09 
Cenário: Post de criação de reserva com um adulto e uma criança em voo GRU/MIA
...
@CT10 
Cenário: Post de criação de reserva com um adulto e um bebê em voo GIG/LAS
    ...
    @CT11
Cenário: Post de criação de reserva com nove adultos em voo LAS/GRU
    ...
    @CT12
Cenário: Post de criação de reserva com um adulto e oito crianças em voo GIG/MIA
    ...
    @CT13
Cenário: Post de criação de reserva com três adultos, três crianças e três bebês em voo GRU/BOS
    ...
    @CT14
Cenário: Post de criação de reserva com um adulto estrangeiro em voo BOS/GIG

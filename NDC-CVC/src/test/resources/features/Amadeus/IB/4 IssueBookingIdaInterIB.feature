...
Funcionalidade: Validação de post em emissão de reserva para voo ida da companhia IBERIA
    Eu como usuário quero emitir minha reserva aérea somente ida da companhia IBERIA


    Cenário: Post de emissão de reserva com um adulto em voo ida MAD/BCN 
    ...
    Cenário: Post de emissão de reserva com um adulto e uma criança em voo ida GRU/MAD 
    ...
    Cenário: Post de emissão de reserva com um adulto e um bebÊ em voo ida GIG/BCN 
    ...
    Cenário: Post de emissão de reserva com nove adultos em voo ida GRU/BCN 
    ...
    Cenário: Post de emissão de reserva com um adulto e oito crianças em voo ida MAD/GIG
    ...
    Cenário: Post de emissão de emissão com um adulto estrangeiro em voo ida BCN/GRU

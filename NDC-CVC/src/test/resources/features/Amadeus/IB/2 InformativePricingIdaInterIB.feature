...
Funcionalidade: Validação de get em InformativePricing Ida
  ...
  @CT08 
  Cenário: Get de confirmação de preço com um adulto MAD/BCN 
  ...
  @CT09
   Cenário: Get de confirmação de preço com um adulto e uma criança GRU/MAD
  ...
  @CT10
  Cenário: Get de confirmação de preço com um adulto e um bebê GIG/BCN
  ...
  @CT11
  Cenário: Get de confirmação de preço com nove adultos GRU/BCN
  ...
  @CT12
  Cenário: Get de confirmação de preço com um adulto e oito crianças MAD/GIG
  ...
  @CT13
  Cenário: Get de confirmação de preço com três adultos, três crianças e três bebês GRU/MAD
  ...
  @CT14
  Cenário: Get de confirmação de preço com um adulto estrangeiro BCN/GRU

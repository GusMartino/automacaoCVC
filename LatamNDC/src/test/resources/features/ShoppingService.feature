...
Funcionalidade: Validação de get em FlightAvailability
  ...
  Cenário: Get com um adulto SAO/RIO
   ...
   @CT03 
   Cenário: Get com um adulto e um bebê SAO/MAD
   ...
   Cenário: Get com nove adultos MAD/SAO
    ...
    E válido em body response se há passageiro "ADT"
    E válido em body response quantidade de passageiros 9
   ...
   Cenário: Get com um adulto e oito crianças BPS/FLN
    ...
    E válido em body response se há passageiro "ADT"
    E válido em body response passageiro "CHD"
    E válido em body response quantidade de passageiros 8
   ...
   Cenário: Get com três adultos, três crianças e três bebês FLN/GRU
    ...
    E válido em body response passageiro "CHD"      
    E válido em body response passageiro "INF"
    E válido em body response quantidade de passageiros 3      